	...
	// ================
      ...
      //TODO
       ...
       //FIN_TODO
        ...
        actionDefausser.add(new ChangerRace(Constante.RACE_HUMAINE));
        cartes.add(new carte.Race(72, "Elfe", "+1 pour déguerpir/ Vous gagnez un niveau pour chaque monstre que vous avez aidé à tuer.", new Equipement(actionEquipement), new UtiliserCarte(null), new ComportementDefausserCarte(actionDefausser)));
        
        nouvelEquipementRace(actionEquipement, Constante.RACE_ELFE);
        actionDefausser.add(new ChangerRace(Constante.RACE_HUMAINE));
        cartes.add(new carte.Race(73, "Elfe", "+1 pour déguerpir/ Vous gagnez un niveau pour chaque monstre que vous avez aidé à tuer.", new Equipement(actionEquipement), new UtiliserCarte(null), new ComportementDefausserCarte(actionDefausser)));
        
        nouvelEquipementRace(actionEquipement, Constante.RACE_ELFE);
        actionDefausser.add(new ChangerRace(Constante.RACE_HUMAINE));
        cartes.add(new carte.Race(74, "Elfe", "+1 pour déguerpir/ Vous gagnez un niveau pour chaque monstre que vous avez aidé à tuer.", new Equipement(actionEquipement), new UtiliserCarte(null), new ComportementDefausserCarte(actionDefausser)));

        nouvelEquipementRace(actionEquipement, Constante.RACE_NAIN);
        actionDefausser.add(new ChangerRace(Constante.RACE_HUMAINE));
        cartes.add(new carte.Race(75, "Nain", "Vous pouvez porter autant de Gros objets que vous voulez. Vous pouvez avoir 6 cartes dans votre main", new Equipement(actionEquipement), new UtiliserCarte(null), new ComportementDefausserCarte(actionDefausser)));
        
        nouvelEquipementRace(actionEquipement, Constante.RACE_NAIN);
        actionDefausser.add(new ChangerRace(Constante.RACE_HUMAINE));
        cartes.add(new carte.Race(76, "Nain", "Vous pouvez porter autant de Gros objets que vous voulez. Vous pouvez avoir 6 cartes dans votre main", new Equipement(actionEquipement), new UtiliserCarte(null), new ComportementDefausserCarte(actionDefausser)));
        
        nouvelEquipementRace(actionEquipement, Constante.RACE_NAIN);
        actionDefausser.add(new ChangerRace(Constante.RACE_HUMAINE));
        cartes.add(new carte.Race(77, "Nain", "Vous pouvez porter autant de Gros objets que vous voulez. Vous pouvez avoir 6 cartes dans votre main", new Equipement(actionEquipement), new UtiliserCarte(null), new ComportementDefausserCarte(actionDefausser)));
        
        nouvelEquipementRace(actionEquipement, Constante.RACE_HALFELIN);
        actionDefausser.add(new ChangerRace(Constante.RACE_HUMAINE));
        cartes.add(new carte.Race(78, "Halfelin", "Vous pouvez vendre un objet par tour au double de son prix (les autres objets sont au prix normal). Si vous ratez votre première tentative pour déguerpir, vous pouvez défausser une carte pour réésayer une fois.", new Equipement(actionEquipement), new UtiliserCarte(null), new ComportementDefausserCarte(actionDefausser)));
        
        nouvelEquipementRace(actionEquipement, Constante.RACE_HALFELIN);
        actionDefausser.add(new ChangerRace(Constante.RACE_HUMAINE));
        cartes.add(new carte.Race(79, "Halfelin", "Vous pouvez vendre un objet par tour au double de son prix (les autres objets sont au prix normal). Si vous ratez votre première tentative pour déguerpir, vous pouvez défausser une carte pour réésayer une fois.", new Equipement(actionEquipement), new UtiliserCarte(null), new ComportementDefausserCarte(actionDefausser)));
        
        nouvelEquipementRace(actionEquipement, Constante.RACE_HALFELIN);
        actionDefausser.add(new ChangerRace(Constante.RACE_HUMAINE));
        cartes.add(new carte.Race(80, "Halfelin", "Vous pouvez vendre un objet par tour au double de son prix (les autres objets sont au prix normal). Si vous ratez votre première tentative pour déguerpir, vous pouvez défausser une carte pour réésayer une fois.", new Equipement(actionEquipement), new UtiliserCarte(null), new ComportementDefausserCarte(actionDefausser)));
        
        nouvelEquipementClasse(actionEquipement, Constante.CLASSE_PRETRE);
        actionDefausser.add(new ChangerClasse(Constante.CLASSE_AUCUNE));
        cartes.add(new carte.Classe(81, "Prêtre", "Résurrection: quand vous devez tirer des cartes face visible, vous pouvez choisir de tirer à la place le même nombre de carte de la défausse appropriée (Trésor ou Donjon). Vous devez ensuite défausser une carte de votre main pour chaque carte que vous avez tirée ainsi. Renvoi: Vous pouvez défausser jusqu'à 3 cartes en combat contre une créature de type Mort-vivant. Chaque carte défaussée vous donne un bonus de +3", new Equipement(actionEquipement), new UtiliserCarte(null), new ComportementDefausserCarte(actionDefausser)));
        
        nouvelEquipementClasse(actionEquipement, Constante.CLASSE_PRETRE);
        actionDefausser.add(new ChangerClasse(Constante.CLASSE_AUCUNE));
        cartes.add(new carte.Classe(82, "Prêtre", "Résurrection: quand vous devez tirer des cartes face visible, vous pouvez choisir de tirer à la place le même nombre de carte de la défausse appropriée (Trésor ou Donjon). Vous devez ensuite défausser une carte de votre main pour chaque carte que vous avez tirée ainsi. Renvoi: Vous pouvez défausser jusqu'à 3 cartes en combat contre une créature de type Mort-vivant. Chaque carte défaussée vous donne un bonus de +3", new Equipement(actionEquipement), new UtiliserCarte(null), new ComportementDefausserCarte(actionDefausser)));
        
        nouvelEquipementClasse(actionEquipement, Constante.CLASSE_PRETRE);
        actionDefausser.add(new ChangerClasse(Constante.CLASSE_AUCUNE));
        cartes.add(new carte.Classe(83, "Prêtre", "Résurrection: quand vous devez tirer des cartes face visible, vous pouvez choisir de tirer à la place le même nombre de carte de la défausse appropriée (Trésor ou Donjon). Vous devez ensuite défausser une carte de votre main pour chaque carte que vous avez tirée ainsi. Renvoi: Vous pouvez défausser jusqu'à 3 cartes en combat contre une créature de type Mort-vivant. Chaque carte défaussée vous donne un bonus de +3", new Equipement(actionEquipement), new UtiliserCarte(null), new ComportementDefausserCarte(actionDefausser)));
        
        nouvelEquipementClasse(actionEquipement, Constante.CLASSE_VOLEUR);
        actionDefausser.add(new ChangerClasse(Constante.CLASSE_AUCUNE));
        cartes.add(new carte.Classe(84, "Voleur", "Poignarder: Vous pouvez défausser une carte pour poignarder un autre joueur dans le dos (-2 au combat). Vous ne pouvez le faire qu'une fois par victime et par combat, mais si deux joueurs combattent ensemble, vous pouvez les poignarder tous les deux. Vol à la tire: vous pouvez défausser une carte pour essayer de voler un petit objet porté par un autre joueur. Lancez un dé: vous réussissez si vous faites 4 ou plus. Sinon, vous prenez une torgnole et perdez un niveau.", new Equipement(actionEquipement), new UtiliserCarte(actionUtiliser), new ComportementDefausserCarte(actionDefausser)));
        
        nouvelEquipementClasse(actionEquipement, Constante.CLASSE_VOLEUR);
        actionDefausser.add(new ChangerClasse(Constante.CLASSE_AUCUNE));
        cartes.add(new carte.Classe(85, "Voleur", "Poignarder: Vous pouvez défausser une carte pour poignarder un autre joueur dans le dos (-2 au combat). Vous ne pouvez le faire qu'une fois par victime et par combat, mais si deux joueurs combattent ensemble, vous pouvez les poignarder tous les deux. Vol à la tire: vous pouvez défausser une carte pour essayer de voler un petit objet porté par un autre joueur. Lancez un dé: vous réussissez si vous faites 4 ou plus. Sinon, vous prenez une torgnole et perdez un niveau.", new Equipement(actionEquipement), new UtiliserCarte(actionUtiliser), new ComportementDefausserCarte(actionDefausser)));
        
        nouvelEquipementClasse(actionEquipement, Constante.CLASSE_VOLEUR);
        actionDefausser.add(new ChangerClasse(Constante.CLASSE_AUCUNE));
        cartes.add(new carte.Classe(86, "Voleur", "Poignarder: Vous pouvez défausser une carte pour poignarder un autre joueur dans le dos (-2 au combat). Vous ne pouvez le faire qu'une fois par victime et par combat, mais si deux joueurs combattent ensemble, vous pouvez les poignarder tous les deux. Vol à la tire: vous pouvez défausser une carte pour essayer de voler un petit objet porté par un autre joueur. Lancez un dé: vous réussissez si vous faites 4 ou plus. Sinon, vous prenez une torgnole et perdez un niveau.", new Equipement(actionEquipement), new UtiliserCarte(null), new ComportementDefausserCarte(actionDefausser)));
